    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            */
            ...
            dt_TruyVan.Parameters.AddWithValue("@bien1", "nvb");
            dt_TruyVan.Parameters.AddWithValue("@bien2", "6688");
            dt_TruyVan.Parameters.AddWithValue("@bien3", 3);
            ...
            // số dòng ảnh hưởng
            Console.WriteLine($"So dong anh huong (UPDATE): {rows_affected}");
